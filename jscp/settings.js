...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|SAYANGKUUU|❤',
    sequenceColor: '#ff69b4', // Màu pink mẫu
    gift: './image/birthday.gif',
    enableBook: true,
    pages: [
...
const gifOptions = [
    ...
    { value: './gif/birthday.gif', label: 'Gif5' },
];
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        matrixColor1: '#ff69b4', // Màu pink mẫu
        matrixColor2: '#ff1493', // Màu pink mẫu
        sequence: 'HAPPY|BIRTHDAY|TO|IGNES|LUHTITA|PRAMESWARI|❤',
        sequenceColor: '#ff69b4', // Màu pink mẫu
        gift: './image/birthday.gif',
        enableBook: true,
        enableHeart: true,
        ...
        pages: [
            ...
            // --- Lembar 2 (data-page="1") ---
            { 
                image: './image/photos/a2.jpg', // Menggantikan fjr3qh.png (Index 2)
